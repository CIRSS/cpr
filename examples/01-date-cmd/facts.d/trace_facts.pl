...
%---------------------------------------------------------------------------------------------------
cpr_execution(e1, r0, p1, '/mnt/cpr/examples/01-date-cmd/./run.sh', '/mnt/cpr/examples/01-date-cmd', nil).
cpr_execution(e2, r0, p2, '/usr/bin/date', '/mnt/cpr/examples/01-date-cmd', nil).
...
%---------------------------------------------------------------------------------------------------
cpr_file_open(o31, r0, p2, '/mnt/cpr/examples/01-date-cmd', 4, true, nil).
