...
wt_accessed_path(o33, r0, '/tmp/_MEIBEz0Lk', i0, nil).
wt_accessed_path(o34, r0, '/etc/ld.so.cache', i11, os).
wt_accessed_path(o35, r0, '/lib/x86_64-linux-gnu/libc.so.6', i12, os).
wt_accessed_path(o36, r0, '/etc/localtime', i13, os).
