...
wt_accessed_path(o32, r0, '/lib/x86_64-linux-gnu/ld-2.28.so', i8, os).
wt_accessed_path(o33, r0, '/home/repro/reprozip/dist/main', i10, nil).
wt_accessed_path(o34, r0, '/etc/ld.so.cache', i15, os).
wt_accessed_path(o35, r0, '/lib/x86_64-linux-gnu/libc.so.6', i16, os).
wt_accessed_path(o36, r0, '/etc/localtime', i17, os).
