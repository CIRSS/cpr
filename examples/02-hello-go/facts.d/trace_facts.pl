...
%---------------------------------------------------------------------------------------------------
rpz_execution(e1, r0, p1, '/mnt/cpr/examples/02-hello-go/./run.sh', '/mnt/cpr/examples/02-hello-go', nil).
rpz_execution(e2, r0, p2, '/mnt/cpr/examples/02-hello-go/./bin/hello_go', '/mnt/cpr/examples/02-hello-go', nil).
...
%---------------------------------------------------------------------------------------------------
rpz_file_open(o20, r0, p2, '/mnt/cpr/examples/02-hello-go', 4, true, nil).
rpz_file_open(o21, r0, p2, '/mnt/cpr/examples/02-hello-go/bin/hello_go', 1, false, nil).
rpz_file_open(o22, r0, p2, '/sys/kernel/mm/transparent_hugepage/hpage_pmd_size', 1, false, nil).
...
wt_accessed_path(o20, r0, '.', i2, sw).
wt_accessed_path(o21, r0, './bin/hello_go', i4, sw).
wt_accessed_path(o22, r0, '/sys/kernel/mm/transparent_hugepage/hpage_pmd_size', i6, os).
