...
wt_accessed_path(o22, r0, './bin/hello_go', i4, sw).
wt_accessed_path(o23, r0, '/sys/kernel/mm/transparent_hugepage/hpage_pmd_size', i6, os).
wt_accessed_path(o24, r0, '.', i2, sw).
wt_accessed_path(o25, r0, '.', i2, sw).
wt_accessed_path(o26, r0, '.', i2, sw).
wt_accessed_path(o27, r0, '.', i2, sw).
wt_accessed_path(o28, r0, '/proc/self/exe', i10, os).
