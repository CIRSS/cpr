...
%---------------------------------------------------------------------------------------------------
cpr_execution(e1, r0, p1, '/mnt/cpr/examples/03-hello-c/./run.sh', '/mnt/cpr/examples/03-hello-c', nil).
cpr_execution(e2, r0, p2, '/mnt/cpr/examples/03-hello-c/./bin/hello_c', '/mnt/cpr/examples/03-hello-c', nil).
...
%---------------------------------------------------------------------------------------------------
cpr_file_open(o20, r0, p2, '/mnt/cpr/examples/03-hello-c', 4, true, nil).
cpr_file_open(o21, r0, p2, '/mnt/cpr/examples/03-hello-c/bin/hello_c', 1, false, nil).
