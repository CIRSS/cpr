...
wt_file_read(o22,r0,p2,i7,'/usr/lib/x86_64-linux-gnu/ld-2.31.so',os).
wt_file_read(o24,r0,p2,i10,'/etc/ld.so.cache',os).
wt_file_read(o25,r0,p2,i11,'/lib/x86_64-linux-gnu/libc.so.6',os).
