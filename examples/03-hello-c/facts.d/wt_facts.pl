...
wt_accessed_path(o23, r0, '/home/repro/reprozip/dist/main', i9, nil).
wt_accessed_path(o24, r0, '/etc/ld.so.cache', i14, os).
wt_accessed_path(o25, r0, '/lib/x86_64-linux-gnu/libc.so.6', i15, os).
