...
%---------------------------------------------------------------------------------------------------
rpz_execution(e1, r0, p1, '/mnt/wt-prov-model/examples/03-hello-c/./run.sh', '/mnt/wt-prov-model/examples/03-hello-c', nil).
rpz_execution(e2, r0, p2, '/mnt/wt-prov-model/examples/03-hello-c/./bin/hello_c', '/mnt/wt-prov-model/examples/03-hello-c', nil).
...
%---------------------------------------------------------------------------------------------------
rpz_file_open(o21, r0, p2, '/mnt/wt-prov-model/examples/03-hello-c', 4, true, nil).
rpz_file_open(o22, r0, p2, '/mnt/wt-prov-model/examples/03-hello-c/bin/hello_c', 1, false, nil).
