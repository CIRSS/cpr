...
%---------------------------------------------------------------------------------------------------
rpz_file_open(o31, r0, p2, '/mnt/wt-prov-model/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o32, r0, p2, '/mnt/wt-prov-model/examples/04-date-to-file/outputs/date.txt', 2, false, nil).
...
rpz_file_open(o43, r0, p3, '/mnt/wt-prov-model/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o55, r0, p4, '/mnt/wt-prov-model/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o56, r0, p4, '/lib/x86_64-linux-gnu/ld-2.28.so', 1, false, nil).
rpz_file_open(o57, r0, p4, '/home/repro/reprozip/dist/main', 8, true, nil).
rpz_file_open(o58, r0, p4, '/etc/ld.so.cache', 1, false, nil).
rpz_file_open(o59, r0, p4, '/lib/x86_64-linux-gnu/libc.so.6', 1, false, nil).
rpz_file_open(o60, r0, p4, '/mnt/wt-prov-model/examples/04-date-to-file/outputs/date.txt', 1, false, nil).
