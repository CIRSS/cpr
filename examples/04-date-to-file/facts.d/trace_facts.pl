...
%---------------------------------------------------------------------------------------------------
cpr_execution(e1, r0, p1, '/mnt/cpr/examples/04-date-to-file/./run.sh', '/mnt/cpr/examples/04-date-to-file', nil).
cpr_execution(e2, r0, p2, '/usr/bin/date', '/mnt/cpr/examples/04-date-to-file', nil).
cpr_execution(e3, r0, p4, '/usr/bin/cat', '/mnt/cpr/examples/04-date-to-file', nil).
...
cpr_argument(e3, 1, '/mnt/cpr/examples/04-date-to-file/outputs/date.txt').

%---------------------------------------------------------------------------------------------------
% FACT: cpr_file_open(OpenID, RunID, ProcessID, FilePath, Mode, IsDirectory, Timestamp).
%---------------------------------------------------------------------------------------------------
cpr_file_open(o31, r0, p2, '/mnt/cpr/examples/04-date-to-file', 4, true, nil).
cpr_file_open(o32, r0, p2, '/mnt/cpr/examples/04-date-to-file/outputs/date.txt', 2, false, nil).
...
cpr_file_open(o43, r0, p3, '/mnt/cpr/examples/04-date-to-file', 4, true, nil).
cpr_file_open(o55, r0, p4, '/mnt/cpr/examples/04-date-to-file', 4, true, nil).
...
cpr_file_open(o60, r0, p4, '/mnt/cpr/examples/04-date-to-file/outputs/date.txt', 1, false, nil).
