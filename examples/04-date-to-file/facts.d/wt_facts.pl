...
wt_accessed_path(o32, r0, './outputs/date.txt', i10, out).
wt_accessed_path(o33, r0, '/lib/x86_64-linux-gnu/ld-2.28.so', i11, os).
wt_accessed_path(o34, r0, '/tmp/_MEIAfW44Y', i0, nil).
wt_accessed_path(o35, r0, '/etc/ld.so.cache', i14, os).
wt_accessed_path(o36, r0, '/lib/x86_64-linux-gnu/libc.so.6', i15, os).
wt_accessed_path(o37, r0, '/etc/localtime', i16, os).
wt_accessed_path(o43, r0, '.', i4, sw).
wt_accessed_path(o55, r0, '.', i4, sw).
wt_accessed_path(o56, r0, '/lib/x86_64-linux-gnu/ld-2.28.so', i11, os).
wt_accessed_path(o57, r0, '/tmp/_MEIAfW44Y', i0, nil).
wt_accessed_path(o58, r0, '/etc/ld.so.cache', i14, os).
wt_accessed_path(o59, r0, '/lib/x86_64-linux-gnu/libc.so.6', i15, os).
wt_accessed_path(o60, r0, './outputs/date.txt', i10, out).
