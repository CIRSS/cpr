...
wt_accessed_path(o37, r0, '/etc/localtime', i20, os).
wt_accessed_path(o43, r0, '.', i4, sw).
wt_accessed_path(o55, r0, '.', i4, sw).
wt_accessed_path(o56, r0, '/lib/x86_64-linux-gnu/ld-2.28.so', i11, os).
wt_accessed_path(o57, r0, '/home/repro/reprozip/dist/main', i13, nil).
wt_accessed_path(o58, r0, '/etc/ld.so.cache', i18, os).
wt_accessed_path(o59, r0, '/lib/x86_64-linux-gnu/libc.so.6', i19, os).
