...
%---------------------------------------------------------------------------------------------------
rpz_file_open(o29, r0, p2, '/mnt/c/Users/tmcphill/OneDrive/GitRepos/wt-prov-model/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o30, r0, p2, '/mnt/c/Users/tmcphill/OneDrive/GitRepos/wt-prov-model/examples/04-date-to-file/outputs/date.txt', 2, false, nil).
...
rpz_file_open(o35, r0, p2, '/etc/localtime', 1, false, nil).
rpz_file_open(o36, r0, p3, '/mnt/c/Users/tmcphill/OneDrive/GitRepos/wt-prov-model/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o48, r0, p4, '/mnt/c/Users/tmcphill/OneDrive/GitRepos/wt-prov-model/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o49, r0, p4, '/lib/x86_64-linux-gnu/ld-2.24.so', 1, false, nil).
rpz_file_open(o50, r0, p4, '/etc/ld.so.cache', 1, false, nil).
rpz_file_open(o51, r0, p4, '/lib/x86_64-linux-gnu/libc.so.6', 1, false, nil).
rpz_file_open(o52, r0, p4, '/usr/lib/locale/locale-archive', 1, false, nil).
rpz_file_open(o53, r0, p4, '/mnt/c/Users/tmcphill/OneDrive/GitRepos/wt-prov-model/examples/04-date-to-file/outputs/date.txt', 1, false, nil).
