...
%---------------------------------------------------------------------------------------------------
rpz_execution(e1, r0, p1, '/mnt/examples/04-date-to-file/./run.sh', '/mnt/examples/04-date-to-file', nil).
rpz_execution(e2, r0, p2, '/bin/date', '/mnt/examples/04-date-to-file', nil).
rpz_execution(e3, r0, p4, '/bin/cat', '/mnt/examples/04-date-to-file', nil).
...
rpz_argument(e3, 1, '/mnt/examples/04-date-to-file/outputs/date.txt').

%---------------------------------------------------------------------------------------------------
% FACT: rpz_file_open(OpenID, RunID, ProcessID, FilePath, Mode, IsDirectory, Timestamp).
%---------------------------------------------------------------------------------------------------
rpz_file_open(o33, r0, p2, '/mnt/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o34, r0, p2, '/mnt/examples/04-date-to-file/outputs/date.txt', 2, false, nil).
...
rpz_file_open(o46, r0, p3, '/mnt/examples/04-date-to-file', 4, true, nil).
rpz_file_open(o58, r0, p4, '/mnt/examples/04-date-to-file', 4, true, nil).
...
rpz_file_open(o64, r0, p4, '/mnt/examples/04-date-to-file/outputs/date.txt', 1, false, nil).
