...
%---------------------------------------------------------------------------------------------------
rpz_file_open(o31, r0, p2, '/mnt/wt-prov-model/examples/05-cat-file-to-file', 4, true, nil).
rpz_file_open(o32, r0, p2, '/mnt/wt-prov-model/examples/05-cat-file-to-file/outputs/output.txt', 2, false, nil).
...
rpz_file_open(o37, r0, p2, '/mnt/wt-prov-model/examples/05-cat-file-to-file/inputs/input.txt', 1, false, nil).
