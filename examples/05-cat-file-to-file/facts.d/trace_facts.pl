...
%---------------------------------------------------------------------------------------------------
cpr_execution(e1, r0, p1, '/mnt/cpr/examples/05-cat-file-to-file/./run.sh', '/mnt/cpr/examples/05-cat-file-to-file', nil).
cpr_execution(e2, r0, p2, '/usr/bin/cat', '/mnt/cpr/examples/05-cat-file-to-file', nil).
...
%---------------------------------------------------------------------------------------------------
cpr_file_open(o31, r0, p2, '/mnt/cpr/examples/05-cat-file-to-file', 4, true, nil).
cpr_file_open(o32, r0, p2, '/mnt/cpr/examples/05-cat-file-to-file/outputs/output.txt', 2, false, nil).
...
cpr_file_open(o37, r0, p2, '/mnt/cpr/examples/05-cat-file-to-file/inputs/input.txt', 1, false, nil).
