...
%---------------------------------------------------------------------------------------------------
rpz_execution(e1, r0, p1, '/mnt/examples/05-cat-file-to-file/./run.sh', '/mnt/examples/05-cat-file-to-file', nil).
rpz_execution(e2, r0, p2, '/bin/cat', '/mnt/examples/05-cat-file-to-file', nil).
...
%---------------------------------------------------------------------------------------------------
rpz_file_open(o33, r0, p2, '/mnt/examples/05-cat-file-to-file', 4, true, nil).
rpz_file_open(o34, r0, p2, '/mnt/examples/05-cat-file-to-file/outputs/output.txt', 2, false, nil).
...
rpz_file_open(o40, r0, p2, '/mnt/examples/05-cat-file-to-file/inputs/input.txt', 1, false, nil).
