...
rpz_file_open(o24, r0, p2, '/tmp/_MEIi3rh38', 8, true, nil).
...
rpz_file_open(o29, r0, p2, '/tmp/_MEIi3rh38', 8, true, nil).
...
rpz_file_open(o35, r0, p2, '/tmp/_MEIi3rh38/libexpat.so.1', 1, false, nil).
rpz_file_open(o36, r0, p2, '/tmp/_MEIi3rh38/libz.so.1', 1, false, nil).
