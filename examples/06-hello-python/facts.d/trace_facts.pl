...
%---------------------------------------------------------------------------------------------------
cpr_execution(e1, r0, p1, '/mnt/cpr/examples/06-hello-python/./run.sh', '/mnt/cpr/examples/06-hello-python', nil).
cpr_execution(e2, r0, p2, '/mnt/cpr/examples/06-hello-python/./hello.py', '/mnt/cpr/examples/06-hello-python', nil).
cpr_execution(e3, r0, p2, '/usr/bin/python3', '/mnt/cpr/examples/06-hello-python', nil).
...
%---------------------------------------------------------------------------------------------------
cpr_file_open(o20, r0, p2, '/mnt/cpr/examples/06-hello-python', 4, true, nil).
...
cpr_file_open(o133, r0, p2, '/mnt/cpr/examples/06-hello-python/./hello.py', 8, false, nil).
cpr_file_open(o134, r0, p2, '/mnt/cpr/examples/06-hello-python/./hello.py', 1, false, nil).
cpr_file_open(o135, r0, p2, '/mnt/cpr/examples/06-hello-python/./hello.py', 8, false, nil).
cpr_file_open(o136, r0, p2, '/mnt/cpr/examples/06-hello-python/hello.py', 24, false, nil).
cpr_file_open(o137, r0, p2, '/mnt/cpr/examples/06-hello-python/./hello.py', 1, false, nil).
