...
wt_accessed_path(o24, r0, '/tmp/_MEIi3rh38', i0, nil).
...
wt_accessed_path(o29, r0, '/tmp/_MEIi3rh38', i0, nil).
...
wt_accessed_path(o35, r0, '/tmp/_MEIi3rh38/libexpat.so.1', i0, nil).
wt_accessed_path(o36, r0, '/tmp/_MEIi3rh38/libz.so.1', i0, nil).
