...
wt_file_read(o37,r0,p2,i17,'./inputs/file1.txt',in).
wt_file_read(o45,r0,p3,i12,'/lib/x86_64-linux-gnu/ld-2.28.so',os).
wt_file_read(o47,r0,p3,i15,'/etc/ld.so.cache',os).
wt_file_read(o48,r0,p3,i16,'/lib/x86_64-linux-gnu/libc.so.6',os).
...
wt_file_write(o44,r0,p3,i18,'./outputs/file3.txt',out).


%---------------------------------------------------------------------------------------------------
% FACT: wt_data_file(PathIndex, FilePath, PathRole).
%...................................................................................................
wt_data_file(i18,'./outputs/file3.txt',out).
wt_data_file(i17,'./inputs/file1.txt',in).
