...
wt_accessed_path(o37, r0, './inputs/file1.txt', i21, in).
wt_accessed_path(o43, r0, '.', i4, sw).
wt_accessed_path(o44, r0, './outputs/file3.txt', i22, out).
wt_accessed_path(o45, r0, '/lib/x86_64-linux-gnu/ld-2.28.so', i12, os).
wt_accessed_path(o46, r0, '/home/repro/reprozip/dist/main', i14, nil).
wt_accessed_path(o47, r0, '/etc/ld.so.cache', i19, os).
wt_accessed_path(o48, r0, '/lib/x86_64-linux-gnu/libc.so.6', i20, os).
