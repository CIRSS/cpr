...
%---------------------------------------------------------------------------------------------------
rpz_execution(e1, r0, p1, '/mnt/examples/07-two-step-pipeline/./run.sh', '/mnt/examples/07-two-step-pipeline', nil).
rpz_execution(e2, r0, p2, '/bin/cat', '/mnt/examples/07-two-step-pipeline', nil).
rpz_execution(e3, r0, p3, '/bin/cat', '/mnt/examples/07-two-step-pipeline', nil).
...
%---------------------------------------------------------------------------------------------------
rpz_file_open(o33, r0, p2, '/mnt/examples/07-two-step-pipeline', 4, true, nil).
rpz_file_open(o34, r0, p2, '/mnt/examples/07-two-step-pipeline/temp/file2.txt', 2, false, nil).
...
rpz_file_open(o40, r0, p2, '/mnt/examples/07-two-step-pipeline/inputs/file1.txt', 1, false, nil).
rpz_file_open(o46, r0, p3, '/mnt/examples/07-two-step-pipeline', 4, true, nil).
rpz_file_open(o47, r0, p3, '/mnt/examples/07-two-step-pipeline/outputs/file3.txt', 2, false, nil).
...
rpz_file_open(o53, r0, p3, '/mnt/examples/07-two-step-pipeline/temp/file2.txt', 1, false, nil).
