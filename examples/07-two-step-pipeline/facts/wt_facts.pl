...
wt_accessed_path(o34, r0, './temp/file2.txt', i11, tmp).
...
wt_accessed_path(o40, r0, './inputs/file1.txt', i23, in).
wt_accessed_path(o46, r0, '.', i4, sw).
wt_accessed_path(o47, r0, './outputs/file3.txt', i24, out).
...
wt_accessed_path(o53, r0, './temp/file2.txt', i11, tmp).
