...
%---------------------------------------------------------------------------------------------------
cpr_execution(e1, r0, p1, '/mnt/cpr/examples/08-branched-pipeline/./run.sh', '/mnt/cpr/examples/08-branched-pipeline', nil).
cpr_execution(e2, r0, p2, '/usr/bin/cat', '/mnt/cpr/examples/08-branched-pipeline', nil).
cpr_execution(e3, r0, p3, '/usr/bin/cat', '/mnt/cpr/examples/08-branched-pipeline', nil).
cpr_execution(e4, r0, p4, '/usr/bin/cat', '/mnt/cpr/examples/08-branched-pipeline', nil).
cpr_execution(e5, r0, p5, '/usr/bin/cat', '/mnt/cpr/examples/08-branched-pipeline', nil).
cpr_execution(e6, r0, p6, '/usr/bin/cat', '/mnt/cpr/examples/08-branched-pipeline', nil).
cpr_execution(e7, r0, p7, '/usr/bin/cat', '/mnt/cpr/examples/08-branched-pipeline', nil).
...
%---------------------------------------------------------------------------------------------------
cpr_file_open(o31, r0, p2, '/mnt/cpr/examples/08-branched-pipeline', 4, true, nil).
cpr_file_open(o32, r0, p2, '/mnt/cpr/examples/08-branched-pipeline/temp/t12.txt', 2, false, nil).
...
cpr_file_open(o37, r0, p2, '/mnt/cpr/examples/08-branched-pipeline/inputs/i1.txt', 1, false, nil).
cpr_file_open(o38, r0, p2, '/mnt/cpr/examples/08-branched-pipeline/inputs/i2.txt', 1, false, nil).
cpr_file_open(o44, r0, p3, '/mnt/cpr/examples/08-branched-pipeline', 4, true, nil).
cpr_file_open(o45, r0, p3, '/mnt/cpr/examples/08-branched-pipeline/temp/t123.txt', 2, false, nil).
...
cpr_file_open(o50, r0, p3, '/mnt/cpr/examples/08-branched-pipeline/inputs/i1.txt', 1, false, nil).
cpr_file_open(o51, r0, p3, '/mnt/cpr/examples/08-branched-pipeline/inputs/i2.txt', 1, false, nil).
cpr_file_open(o52, r0, p3, '/mnt/cpr/examples/08-branched-pipeline/inputs/i3.txt', 1, false, nil).
cpr_file_open(o53, r0, p4, '/mnt/cpr/examples/08-branched-pipeline', 4, true, nil).
cpr_file_open(o54, r0, p4, '/mnt/cpr/examples/08-branched-pipeline/temp/t4.txt', 2, false, nil).
...
cpr_file_open(o59, r0, p4, '/mnt/cpr/examples/08-branched-pipeline/inputs/i4.txt', 1, false, nil).
cpr_file_open(o60, r0, p5, '/mnt/cpr/examples/08-branched-pipeline', 4, true, nil).
cpr_file_open(o61, r0, p5, '/mnt/cpr/examples/08-branched-pipeline/outputs/o12.txt', 2, false, nil).
...
cpr_file_open(o66, r0, p5, '/mnt/cpr/examples/08-branched-pipeline/temp/t12.txt', 1, false, nil).
cpr_file_open(o67, r0, p6, '/mnt/cpr/examples/08-branched-pipeline', 4, true, nil).
cpr_file_open(o68, r0, p6, '/mnt/cpr/examples/08-branched-pipeline/outputs/o1234.txt', 2, false, nil).
...
cpr_file_open(o73, r0, p6, '/mnt/cpr/examples/08-branched-pipeline/temp/t123.txt', 1, false, nil).
cpr_file_open(o74, r0, p6, '/mnt/cpr/examples/08-branched-pipeline/temp/t4.txt', 1, false, nil).
cpr_file_open(o75, r0, p7, '/mnt/cpr/examples/08-branched-pipeline', 4, true, nil).
cpr_file_open(o76, r0, p7, '/mnt/cpr/examples/08-branched-pipeline/outputs/o4.txt', 2, false, nil).
...
cpr_file_open(o81, r0, p7, '/mnt/cpr/examples/08-branched-pipeline/temp/t4.txt', 1, false, nil).
