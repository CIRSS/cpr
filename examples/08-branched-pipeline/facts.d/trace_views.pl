...
%...................................................................................................
wt_process(p7,p1,e7,'/usr/bin/cat').
wt_process(p6,p1,e6,'/usr/bin/cat').
wt_process(p5,p1,e5,'/usr/bin/cat').
wt_process(p4,p1,e4,'/usr/bin/cat').
...
wt_file_read(o46,r0,p3,i10,'/usr/lib/x86_64-linux-gnu/ld-2.31.so',os).
...
wt_file_read(o55,r0,p4,i10,'/usr/lib/x86_64-linux-gnu/ld-2.31.so',os).
...
wt_file_read(o62,r0,p5,i10,'/usr/lib/x86_64-linux-gnu/ld-2.31.so',os).
wt_file_read(o64,r0,p5,i13,'/etc/ld.so.cache',os).
wt_file_read(o65,r0,p5,i14,'/lib/x86_64-linux-gnu/libc.so.6',os).
wt_file_read(o66,r0,p5,i9,'./temp/t12.txt',tmp).
wt_file_read(o69,r0,p6,i10,'/usr/lib/x86_64-linux-gnu/ld-2.31.so',os).
...
wt_file_read(o77,r0,p7,i10,'/usr/lib/x86_64-linux-gnu/ld-2.31.so',os).
...
%...................................................................................................
wt_file_write(o32,r0,p2,i9,'./temp/t12.txt',tmp).
...
wt_data_file(i9,'./temp/t12.txt',tmp).
